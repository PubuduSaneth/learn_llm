...
- Important to understand three main concepts in attention weights calculation
  - *Q, K and V* roles input token embeddings play in attention mechanism
  - *Q, K, V projection* and *learnable projection matrices* used in the projection
  - *Attention weights*
...
### Step 2: Generate context vector
...
### Main Stages: $softmax(\frac{QK^T}{\sqrt{d_k}})$
